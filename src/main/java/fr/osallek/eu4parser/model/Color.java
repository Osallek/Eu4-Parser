...
public class Color {
    ...
    public int getRed() {
        return Math.max(0, Math.min(255, this.isDouble ? (int) (this.list.getAsDouble(0).orElse(0d) * 255) : this.list.getAsInt(0).orElse(0)));
    }
    ...
    public int getGreen() {
        return Math.max(0, Math.min(255, this.isDouble ? (int) (this.list.getAsDouble(1).orElse(0d) * 255) : this.list.getAsInt(1).orElse(0)));
    }
    ...
    public int getBlue() {
        return Math.max(0, Math.min(255, this.isDouble ? (int) (this.list.getAsDouble(2).orElse(0d) * 255) : this.list.getAsInt(2).orElse(0)));
    }
